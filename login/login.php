...
<header id="site login">
		...
		<form action="login.php" method="post">
		      ...
		      <label for="username-input" id="username-label">Username:</label>
		        ...
		        <input placeholder="username" class="text-box" type="text" id="username-input" name="username" maxlength="30" value="<?php echo htmlentities($username); ?>" />
		      
		    
		      <label for="password-input" id="password-label">Password:</label>
		      
		        <input placeholder="password" class="text-box" type="password" id="password-input" name="password" maxlength="30" value="<?php echo htmlentities($password); ?>" />
