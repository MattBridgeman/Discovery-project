...
<?php // if (get_comment_type() == "comment"){ // If you wanted to separate comments from pingbacks ?>
   	<li <?php comment_class(); ?> id="li-comment-<?php comment_ID() ?>">
     		...
     		<?php if(get_comment_type() == "comment"){ ?>
          	...
          	<?php } ?>
           	...
           	<?php if(get_comment_type() == "comment"){ ?>
           		...
           		<span class="date"><?php echo get_comment_date("j F Y"); ?> <?php _e('at',woothemes); ?> <?php echo get_comment_time(); ?></span>
           		<span class="edit"><?php edit_comment_link('Edit', '', ''); ?></span>
           		<span class="perma"><a class="comment-permalink" href="<?php echo get_comment_link(); ?>" title="Direct link to this comment">#</a></span>
        ...
        <div class="comment-entry"  id="comment-<?php comment_ID(); ?>">
			...
			<?php comment_text() ?>
			<?php if ($comment->comment_approved == '0') { ?> <p class='unapproved'><?php _e('Your comment is awaiting moderation.',woothemes); ?></p> <?php } ?>
